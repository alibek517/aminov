      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-x-auto">
        <table className="w-full min-w-[700px]">
          ...
          <tbody className="divide-y">
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={5} className="px-6 py-6 text-center text-gray-500">Ma'lumot yo‘q</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      {modal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg w-full max-w-md p-6">
            <h2 className="text-lg font-semibold mb-4">{modal === 'add' ? "Mijoz qo‘shish" : "Mijozni tahrirlash"}</h2>
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                <button type="button" onClick={close} className="px-4 py-2 bg-gray-100 rounded-lg">Bekor qilish</button>
